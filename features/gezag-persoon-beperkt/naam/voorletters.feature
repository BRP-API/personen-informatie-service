...
@proxy
Functionaliteit: Bepalen van voorletters uit de voornamen van een persoon (gezag persoon beperkt)
...
Wanneer na een voorletter zonder punt (voornaam had één letter) nog een andere voorletter volgt, wordt daartussen een spatie gezet.
  ...
  Regel: Voorletters wordt samengesteld uit de eerste letter van de voornamen gescheiden door een punt
    ...
    Abstract Scenario: <titel>
      ...
      En de persoon met burgerservicenummer '000000413' heeft de volgende gegevens
      | naam                  | waarde      |
    ...
    Scenario: Geen voornamen
      ...
      | gemeentecode (92.10) | identificatiecode verblijfplaats (11.80) |
      | 0599                 | 0599010051001502                         |
      En de persoon met burgerservicenummer '000000425' heeft de volgende gegevens
      | naam                  | waarde   |
      | voornamen (02.10)     |          |
