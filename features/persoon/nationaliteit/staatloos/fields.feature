...
@proxy
Functionaliteit: Persoon: 'staatloos' nationaliteit velden vragen met fields
  ...
  Abstract Scenario: 'reden opname (63.10)' met waarde '000' wordt gevraagd met field pad '<fields>'
    Gegeven de persoon met burgerservicenummer '000000012' heeft een 'nationaliteit' met de volgende gegevens
    | naam                  | waarde |
    | nationaliteit (05.10) | 0499   |
