...
public static class OverlijdenInOnderzoekExtensions
{
    public static BrpApiDtos.OverlijdenInOnderzoek? OverlijdenInOnderzoek(this BrpDtos.InOnderzoek? source)
    {
        if(source == null)
        {
            return null;
