...
public static class AdresseringMapper
{
    public static AdresseringBeperkt? Map(this HaalCentraal.BrpProxy.Generated.Gba.GbaPersoonBeperkt src)
    {
    ...
    public static Adressering? Map(this HaalCentraal.BrpProxy.Generated.Gba.GbaPersoon src)
    {
